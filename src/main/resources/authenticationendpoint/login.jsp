...
<%!
    ...
    private static final String FIDP_AUTHENTICATOR = "FIDP";
...
<%
    ...
    if (isIdentifierFirstLogin(inputType)) {
        ...
        if (StringUtils.isBlank(authAPIURL)) {
            String servicesURL = EndpointConfigManager.getServicesURL();
            if (StringUtils.isBlank(servicesURL)) {
                authAPIURL = IdentityUtil.getServerURL("/api/identity/auth/v1.1/", true, true);
            } else {
                authAPIURL = IdentityUtil.getServerURLUsingServicesURL(servicesURL, "/api/identity/auth/v1.1/", true, true);
            }
        }
            ...
            <div class="ui segment">
                ...
                <div class="segment-form">
                    ...
                    <%
                            ...
                            localAuthenticatorNames.contains(BASIC_AUTHENTICATOR) || localAuthenticatorNames.contains(FIDP_AUTHENTICATOR)) {
                            hasLocalLoginOptions = true;
                            ...
                            } else if (localAuthenticatorNames.contains(BASIC_AUTHENTICATOR) || localAuthenticatorNames.contains(FIDP_AUTHENTICATOR)) {
                    ...
                    %>
                    <% if (localAuthenticatorNames.contains(BASIC_AUTHENTICATOR) || localAuthenticatorNames.contains(FIDP_AUTHENTICATOR) ||
